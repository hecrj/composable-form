module Page.Composability.WithConfiguration exposing (Model, Msg, init, update, view)
...
import Page.Composability.WithConfiguration.AddressForm as AddressForm exposing (AddressForm)
